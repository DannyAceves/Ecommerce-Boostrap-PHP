...
<page backtop="10mm" backbottom="10mm" backleft="10mm" backright="20mm">
    ...
    <page_header>
        <table id="encabezado">
            <tr class="fila">
                <td id="col_1" >
                    <img src="../../Atom.png" width="80" height=80>                    
                </td>
                <td id="col_2">
                    <span id="span1">Atom STORE</span>
                    <br>
                    <span id="span2">Tecnico. Leonardo Ramirez</span>
                </td>
                <td><br></td>
                <td><br></td>
            </tr>
    ...
    <page_footer> 
        <table id="footer">
            <tr class="fila">
                <td>
                    <span>E-COMMERCE - Desing by Tecnico:Leonardo Ramirez - 2015</span>
                </td>
            </tr>
        </table>
    </page_footer>
