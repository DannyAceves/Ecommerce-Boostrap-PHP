...
<page backtop="10mm" backbottom="10mm" backleft="10mm" backright="20mm">
    ...
    <page_header>
        <table id="encabezado">
            <tr class="fila">
                <td id="col_1" >
                    <img src="img/04.jpg" style="height:90px; width:90px;" alt="">
                </td>
                <td id="col_2">
                    <span id="span1">Gamestron</span>
                    <br>
                    <span id="span2">GAMES & PLAYS</span>
                </td>
                <td><br></td>
                <td><br></td>
            </tr>
    ...
    <page_footer> 
        <table id="footer">
            <tr class="fila">
                <td>
                    <span>GAMESTRON @ 2017 By GAMESTRON </span>
                </td>
            </tr>
        </table>
    </page_footer>
...
<div class="collapse navbar-collapse" id="navegacion-leo" >
      <div><!-- /.navbar-collapse -->
      <hr style="background:graycyan;">
      </div><!-- /.container-fluid -->
</div>
    <div class="container"> 
    <div class="navbar-header" style="font-size:20px; text-align:center;">
       <b> <?php echo $a['nombre']; ?> ¡Su compra ha sido realizada!</b>
    </div>
  </div>
    ...
    <table id="central">
        ...
        <tr>
            ...
            <table style="width:900px;">
                ...
                if ($siesta>0) {
                do {
                echo "<br><br><tr style='height:100px; margin-top:10px;'>";
...
<div class="collapse navbar-collapse" id="navegacion-leo" >
    ...
    <div class="container"> 
    <div class="navbar-header" style="font-size:22px; text-align:center;">
       !FELICIDADES COMPRA FINALIZADA¡
    </div>
  </div>
